...
if __name__ == '__main__':
    ...
    b2 = W.MeshObject(np.array((-5-80,5-30,60)), f3, mesh.Mesh.from_file('models/lowpoly_burden_bear_by_junxi.stl'), np.array((.8, .5, 0)), mirror=0.1, threads=8, chunk_size=60)
